    ...
    return (
        <SimpleForm {...props} toolbar={<CustomToolbar record={props.record}/>}
          ...
          {children}
            ...
            {/*<TabbedDatagrid/>*/}
            <TextInput source={"title"} fullWidth label={translate("resources.template.title")}
                       className={"width100 mb-20"}
                       validate={Val.req}/>

            <div className={"mb-20"}></div>

            <TextInput source="type" fullWidth label={translate("resources.template.type")}
                       className={"width100 mb-20 ltr"}/>
            <TextInput multiline fullWidth source="excerpt" label={translate("resources.template.excerpt")}/>
            <RichTextInput multiline fullWidth source="description" label={translate("resources.template.description")}/>
            ...
            {/*/>*/}
            {/*<SelectInput*/}
                {/*label={translate("resources.template.kind")}*/}
                {/*defaultValue={"post"}*/}
                {/*source="kind"*/}
                {/*choices={[*/}
                    {/*{id: "post", name: translate("resources.template.post")},*/}
                    {/*{id: "page", name: translate("resources.template.page")}*/}
                {/*]}*/}
            {/*/>*/}
            <SelectInput
