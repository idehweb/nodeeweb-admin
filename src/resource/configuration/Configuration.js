          ...
          <Card sx={{ padding: "1em" }}>
            <Box>
              <Box>
                ...
                <div className={"row"}>
                  ...
                  <div className={"col-md-3"}>
                    ...
                    {logo && <ShowImageField photo={logo} className={"width100"} deleteFunction={false}/>}
                  </div>
              ...
              <Box>
                ...
                <Box>
                    <ReferenceInput perPage={100} label={translate('resources.settings.home')} source="home" reference="page" alwaysOn>
