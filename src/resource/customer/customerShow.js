...
import { List, Notifications, Orders, SimpleForm, Tasks, Transactions,Notes,Documents,CustomerStatus } from "@/components";
      ...
      <SimpleShowLayout>
        <Grid container spacing={2}>
          ...
          <Grid item lg={3} md={4} xs={12}>
            <FunctionField label={translate("resources.customers.tasks")}
                           render={record => (
                             <CustomerStatus record={record}/>)}/>
            <FunctionField label={translate("resources.customers.tasks")}
                           render={record => (
                             <Tasks record={record}/>)}/>
            <FunctionField label={translate("resources.customers.notes")}
                           render={record => (
                             <Notes record={record}/>)}/>
            <FunctionField label={translate("resources.customers.documents")}
                           render={record => (
