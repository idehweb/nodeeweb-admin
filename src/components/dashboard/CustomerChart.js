        ...
        <div style={{ height: 300 }} className={"customer-chart"}>
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={all_data} width={1000}>
              ...
              <Line type="monotone" dataKey={("complete")} label={translate("complete")} stroke="#31bd58"  strokeWidth={2}/>
              <Line type="monotone" dataKey={("paid")} label={translate("paid")} stroke="#1875d2"  strokeWidth={2}/>
