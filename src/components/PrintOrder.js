                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div>
                            ...
                            {codeposti && <div>
                                <span>کد پستی: </span>
                                <span><input style={{width:'400px'}} value={codeposti} onChange={(e) => changeInput('codeposti', e)}/></span>
                            </div>}
                        </div>
                        <div>
                ...
                {props.record.package.map((p, tyhj) => {
                    if (cpackage[tyhj])
                        return (
                            ...
                            {/*{p.product_name}*/}
                                        <textarea style={{height:'auto',minHeight:'25px',float:'right'}}  value={cpackage[tyhj].product_name}
